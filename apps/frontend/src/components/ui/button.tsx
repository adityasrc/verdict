  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-label-caps uppercase font-bold tracking-widest disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 select-none",
  {
    variants: {
      variant: {
        ...
        brutal:
          "bg-primary text-on-primary border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-primary-container transition-all duration-75 linear active:shadow-none active:translate-x-1 active:translate-y-1",
        "brutal-secondary":
          "bg-secondary text-on-secondary border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-emerald-500 transition-all duration-75 linear active:shadow-none active:translate-x-1 active:translate-y-1",
        "brutal-ghost":
        ...
        "brutal-error":
          "bg-error text-on-error border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-red-700 transition-all duration-75 linear active:shadow-none active:translate-x-1 active:translate-y-1",
        "brutal-yellow":
        ...
        default:
          "bg-primary text-on-primary border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-primary-container transition-all duration-75",
        destructive:
          "bg-error text-on-error border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-red-700 transition-all duration-75",
        outline:
        ...
        secondary:
          "bg-secondary text-on-secondary border-[4px] border-on-surface brutal-shadow brutal-button hover:bg-emerald-500 transition-all duration-75",
        ghost:
